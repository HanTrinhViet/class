...
public class TicketServiceTest {
    ...
    void givenTicketDescriptionAndResolutionSummary_whenUpdating_thenDescriptionAndResolutionSummaryAreUpdated() {
        ...
        Ticket originalTicket = new Ticket(ticketId, ticketDto.description(), Status.RESOLVED, now);
    ...
    void givenInvalidDateRange_whenGettingTickets_thenThrowException() {
        TicketFilterDto filterDto = new TicketFilterDto(null, LocalDateTime.of(2023, 6, 25, 0, 0), LocalDateTime.of(1999, 6, 25, 0, 0), null);
